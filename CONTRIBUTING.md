# Contributing to geochem-rf-linkml

:+1: First of all: Thank you for taking the time to contribute!

The following is a set of guidelines for contributing to
geochem-rf-linkml. These guidelines are not strict rules.
...
The geochem-rf-linkml team strives to create a
...
- Pull Requests
    ...
    - PRs should be reviewed and merged in a timely fashion by the geochem-rf-linkml technical leads
...
[issues]: https://github.com/sierra-moxon/geochem-rf-linkml/issues/
[pulls]: https://github.com/sierra-moxon/geochem-rf-linkml/pulls/
